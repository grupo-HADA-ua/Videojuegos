...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div>
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ErrorMessage="Se requiere una edad mínima" 
                ControlToValidate="Edad" CssClass="alert alert-danger" runat="server" />
        </div>
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ErrorMessage="Se requiere el stock"
